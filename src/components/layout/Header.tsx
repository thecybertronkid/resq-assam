    ...
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-xl border-b border-slate-200/80 shadow-xs transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          {/* Decluttered Primary Navigation */}
          <nav className="hidden lg:flex items-center gap-1.5">
            ...
            <div className="relative">
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-semibold flex items-center gap-1 transition-all duration-200 ${
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-xs font-semibold flex items-center gap-2.5 transition-colors ${
                          isActive ? 'bg-pink-50 text-pink-700' : 'text-slate-700 hover:bg-slate-50 hover:text-pink-600'
                        }`}
                      >
              ...
              return (
                <button
                  ...
                  className={`p-2 rounded-xl text-xs font-semibold flex items-center gap-2 text-left transition-colors ${
                    isActive ? 'bg-pink-50 text-pink-700 border border-pink-200' : 'text-slate-700 hover:bg-slate-100'
                  }`}
                >
